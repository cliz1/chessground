...
export const wazirDir: cg.DirectionalCheck = (x1, y1, x2, y2) => diff(x1, x2) + diff(y1, y2) === 1;
...
export const generalDir: cg.DirectionalCheck = (x1, y1, x2, y2) =>
  wazirDir(x1, y1, x2, y2) || rookDir(x1, y1, x2, y2);
