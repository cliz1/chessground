...
export const roles = ['pawn', 'knight', 'bishop', 'rook', 'queen', 'king', 'champion', 'princess', 'amazon', 'mann', 'painter', 'snare', 'wizard', 'archer', 'royalpainter', 'rollingsnare', 'centaur'] as const;
