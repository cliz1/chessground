...
export const championDir = (x1, y1, x2, y2) => knightDir(x1, y1, x2, y2) || rookDir(x1, y1, x2, y2);
export const princessDir = (x1, y1, x2, y2) => knightDir(x1, y1, x2, y2) || bishopDir(x1, y1, x2, y2);
export const amazonDir = (x1, y1, x2, y2) => knightDir(x1, y1, x2, y2) || queenDir(x1, y1, x2, y2);
export const mannDir = (x1, y1, x2, y2) => Math.max(diff(x1, x2), diff(y1, y2)) === 1;
...
export const painterDirCapture = (x1, y1, x2, y2, isDirectionUp) => diff(x1, x2) === 1 && y2 === y1 + (isDirectionUp ? 1 : -1);
export const painterDirAdvance = (x1, y1, x2, y2, isDirectionUp) => {
    const step = isDirectionUp ? 1 : -1;
    return (x1 === x2 &&
        (y2 === y1 + step ||
            // allow 2 squares from first two ranks, for horde
...
// implementation
export function snareDir(x1, y1, x2, y2, isDirectionUp, ..._rest) {
...
export function archerDir(x1, y1, x2, y2) {
