...
export declare const championDir: cg.DirectionalCheck;
export declare const princessDir: cg.DirectionalCheck;
export declare const amazonDir: cg.DirectionalCheck;
export declare const mannDir: cg.DirectionalCheck;
...
export declare const painterDirCapture: (x1: number, y1: number, x2: number, y2: number, isDirectionUp: boolean) => boolean;
export declare const painterDirAdvance: (x1: number, y1: number, x2: number, y2: number, isDirectionUp: boolean) => boolean;
export declare function snareDir(x1: number, y1: number, x2: number, y2: number): boolean;
export declare function snareDir(x1: number, y1: number, x2: number, y2: number, isDirectionUp: boolean, ...rest: any[]): boolean;
